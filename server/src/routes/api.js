...
const initApiRoutes = (app) => {
  ...
  router.put(
    "/user/updateMultiClass",
    userController.updateClassForMultipleUsers
  );
  router.put(
    "/user/moveUserFromClass",
    userController.moveUserFromClassController
  );
  router.delete("/user/delete", userController.deleteFunc);
  router.get("/user/getTeacherNotInClass", userController.getTeacherNotInClass);
  router.put(
    "/user/removeTeacherOutOfClass",
    userController.removeTeacerOutClass
  );
  router.get(
    "/user/getStudentApprovedList",
    userController.getStudentApprovedList
  );
  ...
  router.post("/class/getById", classController.getClassById);
