...
// const nonSecurePaths = ['/logout', '/login','/register','/','/changePassword',
...
// ,'/user/moveUserFromClass','/user/getByID','/user/getTeacherNotInClass', '/user/removeTeacherOutOfClass','/user/getByPhone',
// '/class/read','/class/get','/class/create','/class/delete','/class/addTeacher',"/class/getClassByTeacherID","/class/update",
// '/user/getLecturer','/user/getStudentApprovedList','/user/sendUserInformation',
...
const nonSecurePaths = [
  ...
  "/user/delete",
  "/user/getClassList",
  "/user/getUserNotInClass",
  "/user/updateMultiClass",'/user/getByPhone',
  ...
  '/user/sendUserInformation',
  "/user/moveUserFromClass",
  "/user/getByID",
  "/user/getTeacherNotInClass",
  "/user/removeTeacherOutOfClass",
  "/user/getByPhone",
  "/class/read",
  "/class/get",
  "/class/create",
...
const checkUserPermission = (req, res, next) => {
  if (nonSecurePaths.includes(req.path) || req.path === "/account")
    return next();
  if (req.user && req.user.getClassName) {
